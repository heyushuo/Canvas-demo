...
- 总结：由于实例对象的内部原型 proto 都指向构造函数的原型 prototype，所有的实例对象的公用属性和方法封装到构造函数的原型里面去
...
- [proto 与 prototype 区别-知乎](https://www.zhihu.com/question/34183746/answer/58068402)
...
- tween 的欢动控制选项 \* Konva.Easings.Linear //线性
